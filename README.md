...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/featureclass-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15073&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/featureclass-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `featureclass` can be installed with:

```
conda install featureclass
```

It is possible to list all of the versions of `featureclass` available on your platform with:
